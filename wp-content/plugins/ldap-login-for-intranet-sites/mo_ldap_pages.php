			...
			<table class="mo_ldap_settings_table">
				...
				<tr>
					...
					<td><input class="mo_ldap_table_textbox" type="tel" id="phone"
						...
						value="<?php echo get_option('mo_ldap_local_admin_phone');?>" />
						<i>We will call only if you call for support</i><br><br></td>
				</tr>
				<tr>
					<td><b>First Name:</b></td>
					<td><input class="mo_ldap_table_textbox" type="tel" id="fname"
						name="fname"
						title="First Name"
				...
				<tr>
					<td><b>Last Name:</b></td>
					<td><input class="mo_ldap_table_textbox" type="tel" id="lname"
						name="lname"
						title="Last Name"
	...
	?>
			...
			<form id="mo_form1" name="f" method="post" action="">
				...
				<div id="panel1">
					<table class="mo_ldap_settings_table">
						...
						<?php if(get_option('mo_ldap_local_cust', '1') == 0){ ?>
						<tr>
							<td><b><font color="#FF0000">*</font>Search Filter:</b></td>
							<td><b><?php echo Mo_Ldap_Local_Util::decrypt(get_option('mo_ldap_local_search_filter')); ?></b></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>
								
								<i>You can login using your email, cn or any other LDAP attribute of your choice through the Search Filter.<br><b> Configurable Search Filter is supported in the <a href="<?php echo add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] ); ?>">Premium version</a> of the plugin.</b></i>
							</td>
						</tr>
						<?php }else{ ?>
						<tr>
		...
		<form name="f" method="post" action="">
			...
			<h3>Test Authentication</h3>
				...
				<?php if(get_option('mo_ldap_local_cust', '1') == '0'){ ?>
					Wordpress username is mapped to the <b>CN(common name)</b> attribute in LDAP. Ensure that you have an administrator user in LDAP with the same common name value. <br><b>The support for custom username attribute is in the <a href="<?php echo add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] ); ?>">Premium</a> version of the plugin.</b><br>
				<?php } ?>
	...
	<form id="role_mapping_form" name="f" method="post" action="">
				...
				<div id="panel1">
					<table class="mo_ldap_mapping_table" id="ldap_role_mapping_table" style="width:90%">
						...
						<tr><td style="width:160%;"><b>Add More Mapping - This feature is available in the <a href="<?php echo add_query_arg( array('tab' => 'pricing'), $_SERVER['REQUEST_URI'] ); ?>">Premium version</a> of the plugin.</b><br></td>
						</tr>
...
function show_pricing_page() { ?>
		...
		<tr style="vertical-align:top;">
				...
				<p class="mo_ldap_local_pricing_text" style="padding-bottom:16px !important;">
					...
					Integrated Windows Authentication supported*<br><br>
				</p>
				<br>
				<hr>
