...
<p>
	...
	<small>Run the trigger script when you want to update your import. Once per 24 hours is recommended.</small><br />
	...
	<?php if (! empty($item['options']['tpl_data']) and (empty($item['options']['cpt']) or ! in_array('shop_order', $item['options']['cpt'])) and ! empty($bundle_url)): ?>			
		<?php _e('Import Bundle URL', 'wp_all_export_plugin'); ?><br />	
